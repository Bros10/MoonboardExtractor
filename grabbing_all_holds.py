...
output_file_path = 'climb_details_output.txt'

# Write the results to a file
with open(output_file_path, 'w') as file:
    for problem in problems:
        file.write(str(problem))
        file.write('\n\n')  # Add some space between the problems for readability

print(f"Details of climbs have been written to {output_file_path}")
